...
#define DISP_CS_SET digitalWrite_HIGH(LCD_CS_Pin)
#define DISP_CS_CLR digitalWrite_LOW(LCD_CS_Pin)

#define DISP_RS_SET digitalWrite_HIGH(LCD_DC_Pin)
#define DISP_RS_CLR digitalWrite_LOW(LCD_DC_Pin)
